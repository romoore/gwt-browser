...
public class UriDataProvider extends AsyncDataProvider<WorldState> implements HasRefresh<HasData<WorldState>> {
  ...
  public UriDataProvider(final String snapshotPath) {
    super();
